...
public class GraphMMSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GraphMMPackage.REPOSITORY: {
				Repository repository = (Repository)theEObject;
				T result = caseRepository(repository);
				if (result == null) result = caseGraph(repository);
			...
			case GraphMMPackage.DEPENDENCY: {
			...
			case GraphMMPackage.GRAPH: {
				Graph graph = (Graph)theEObject;
				T result = caseGraph(graph);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GraphMMPackage.METAMODEL: {
				Metamodel metamodel = (Metamodel)theEObject;
				T result = caseMetamodel(metamodel);
				if (result == null) result = caseNode(metamodel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GraphMMPackage.CONFORMANCE: {
				Conformance conformance = (Conformance)theEObject;
				T result = caseConformance(conformance);
				if (result == null) result = caseEdge(conformance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
