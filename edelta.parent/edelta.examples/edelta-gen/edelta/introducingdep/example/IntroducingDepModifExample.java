...
public class IntroducingDepModifExample extends AbstractEdelta {
  ...
  public void aModificationTest(final EPackage it) {
    ...
    EdeltaUtils.addNewEReference(getEClass("anothersimple", "AnotherSimpleClass"), 
    ...
    EdeltaUtils.addNewEReference(referenceToSuperClass, "aReferenceToAnotherSimpleClass", getEClass("anothersimple", "AnotherSimpleClass"), _function);
  }
