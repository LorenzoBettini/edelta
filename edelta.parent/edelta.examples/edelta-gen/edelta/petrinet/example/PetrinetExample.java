...
public class PetrinetExample extends AbstractEdelta {
  ...
  public void introduceAbstractArc(final EPackage it) {
    final Consumer<EClass> _function = (EClass it_1) -> {
      ...
      final List<EAttribute> attributes = Collections.<EAttribute>unmodifiableList(CollectionLiterals.<EAttribute>newArrayList(getEAttribute("petrinet", "PTArc", "weight"), getEAttribute("petrinet", "TPArc", "weight")));
