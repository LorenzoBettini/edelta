...
import edelta.personlist.example.ExampleSyntax1
import edelta.testutils.EdeltaTestUtils
import org.junit.Test

class PersonListSyntax1Test {

	@Test
	def void testModifiedEcoreSyntax1() {
		// Create an instance of the generated Java class
		val edelta = new ExampleSyntax1();
		...
		EdeltaTestUtils.compareSingleFileContents(
			"modified-syntax1/PersonList.ecore",
			'''
