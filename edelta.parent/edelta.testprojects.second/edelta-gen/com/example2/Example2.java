...
public class Example2 extends AbstractEdelta {
  ...
  public void someModifications(final EPackage it) {
    final Consumer<EClass> _function = (EClass it_1) -> {
      ...
      EdeltaUtils.addNewEReference(it_1, "myReference", getEClass("myecore2", "MyEClass"), _function_1);
    };
    EdeltaUtils.addNewEClass(it, "NewClass", _function);
  }
  
  public void otherModifications(final EPackage it) {
    EdeltaUtils.addEClass(it, this.example1.myReusableCreateSubclassOfMyEClass("ASubclassOfMyEClass"));
