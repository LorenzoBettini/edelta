...
public class EdeltaCompilerTest extends EdeltaAbstractTest {
  ...
  public void testOperationAccessingLib() {
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("return this.lib.newEClass(s);");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("}");
    _builder.newLine();
  ...
  public void testOperationNewEClassWithInitializer() {
    ...
    _builder.newLine();
    _builder.append("      ");
    _builder.append("EClass _newEClass = this.lib.newEClass(\"Base\");");
    _builder.newLine();
    _builder.append("      ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("return this.lib.newEClass(s, _function);");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("}");
    _builder.newLine();
  ...
  public void testReferenceToCreatedEClass() {
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("this.lib.addNewEClass(it, \"NewClass\");");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("}");
    _builder.newLine();
  ...
  public void testModifyEcore() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("EClass _newEClass = this.lib.newEClass(\"Base\");");
    _builder_1.newLine();
    _builder_1.append("      ");
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("EClass _newEClass = this.lib.newEClass(\"ANewClass\", _function);");
    _builder_1.newLine();
    _builder_1.append("    ");
  ...
  public void testCompilationRenamedClassInModifyEcore() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("ecoreref(RenamedClass).EStructuralFeatures += newEAttribute(\"anotherAttr\") [");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("final Consumer<EAttribute> _function = (EAttribute it_1) -> {");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("it_1.setEType(getEDataType(\"foo\", \"FooDataType\"));");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("};");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("EAttribute _newEAttribute = this.lib.newEAttribute(\"anotherAttr\", _function);");
    _builder_1.newLine();
    _builder_1.append("    ");
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("final Procedure1<EClass> _function_1 = (EClass it_1) -> {");
    _builder_1.newLine();
    _builder_1.append("      ");
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("getEClass(\"foo\", \"RenamedClass\"), _function_1);");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testCompilationAfterInterpretationOfCreatedEClassStealingAttribute() {
    ...
    _builder.newLine();
    _builder.append("      ");
    _builder.append("this.lib.addEAttribute(it_1, getEAttribute(\"foo\", \"FooClass\", \"myAttribute\"));");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("};");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("this.lib.addNewEClass(it, \"NewClass\", _function);");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("}");
    _builder.newLine();
  ...
  public void testCompilationOfModifyEcoreCallingLibMethods() {
    ...
    _builder.newLine();
    _builder.append("      ");
    _builder.append("this.lib.addNewEAttribute(it_1, \"ANewAttribute\", getEDataType(\"foo\", \"FooDataType\"), _function_1);");
    _builder.newLine();
    _builder.append("      ");
    ...
    _builder.newLine();
    _builder.append("      ");
    _builder.append("this.lib.addNewEReference(it_1, \"ANewReference\", getEClass(\"foo\", \"FooClass\"), _function_2);");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("};");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("this.lib.addNewEClass(it, \"ANewClass\", _function);");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("      ");
    _builder.append("this.lib.addNewEEnumLiteral(it_1, \"ANewEnumLiteral\", _function_2);");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("};");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("this.lib.addNewEEnum(it, \"ANewEnum\", _function_1);");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("this.lib.addNewEDataType(it, \"ANewDataType\", \"java.lang.String\");");
    _builder.newLine();
    _builder.append("    ");
  ...
  public void testCompilationOfComplexOperationsWithSubPackages() {
    ...
    _builder_1.append("import org.eclipse.emf.ecore.EStructuralFeature;");
    _builder_1.newLine();
    _builder_1.append("import org.eclipse.emf.ecore.EcoreFactory;");
    _builder_1.newLine();
    _builder_1.append("import org.eclipse.xtext.xbase.lib.ObjectExtensions;");
    _builder_1.newLine();
    _builder_1.append("import org.eclipse.xtext.xbase.lib.Procedures.Procedure1;");
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("EList<EPackage> _eSubpackages = it.getESubpackages();");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("EPackage _createEPackage = EcoreFactory.eINSTANCE.createEPackage();");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("final Procedure1<EPackage> _function = (EPackage it_1) -> {");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("it_1.setName(\"anewsubpackage\");");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("EList<EPackage> _eSubpackages_1 = it_1.getESubpackages();");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("EPackage _createEPackage_1 = EcoreFactory.eINSTANCE.createEPackage();");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("final Procedure1<EPackage> _function_1 = (EPackage it_2) -> {");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("it_2.setName(\"anestedsubpackage\");");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("this.lib.addNewEClass(it_2, \"ANestedSubPackageClass\");");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("};");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("EPackage _doubleArrow = ObjectExtensions.<EPackage>operator_doubleArrow(_createEPackage_1, _function_1);");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("_eSubpackages_1.add(_doubleArrow);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("};");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("EPackage _doubleArrow = ObjectExtensions.<EPackage>operator_doubleArrow(_createEPackage, _function);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("_eSubpackages.add(_doubleArrow);");
    _builder_1.newLine();
    _builder_1.append("    ");
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("EReference _newEReference = this.lib.newEReference(\"newTestRef\", getEClass(\"foo.anewsubpackage.anestedsubpackage\", \"ANestedSubPackageClass\"));");
    _builder_1.newLine();
    _builder_1.append("      ");
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("this.lib.addNewEClass(getEPackage(\"foo.anewsubpackage\"), \"NewClass\", _function_1);");
    _builder_1.newLine();
    _builder_1.append("    ");
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("EAttribute _newEAttribute = this.lib.newEAttribute(\"added\", getEDataType(\"foo\", \"FooDataType\"));");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("_eStructuralFeatures.add(_newEAttribute);");
    _builder_1.newLine();
  ...
  public void testCompilationOfPersonListExampleModifyEcore() {
    ...
    _builder.newLine();
    _builder.append("      ");
    _builder.append("this.lib.addEAttribute(it_1, ");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("this.lib.addNewEClass(it, \"Place\", _function);");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("      ");
    _builder.append("EList<EStructuralFeature> _eStructuralFeatures = it_1.getEStructuralFeatures();");
    _builder.newLine();
    _builder.append("      ");
    _builder.append("final Consumer<EAttribute> _function_1 = (EAttribute it_2) -> {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("it_2.setEType(getEDataType(\"ecore\", \"EString\"));");
    _builder.newLine();
    _builder.append("      ");
    _builder.append("};");
    _builder.newLine();
    _builder.append("      ");
    _builder.append("EAttribute _newEAttribute = this.lib.newEAttribute(\"description\", _function_1);");
    _builder.newLine();
    _builder.append("      ");
    _builder.append("_eStructuralFeatures.add(_newEAttribute);");
    _builder.newLine();
    _builder.append("      ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("this.lib.addNewEClass(it, \"WorkingPosition\", _function);");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("this.lib.addEReference(getEClass(\"PersonList\", \"List\"), ");
    _builder.newLine();
    _builder.append("      ");
