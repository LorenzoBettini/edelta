...
public class EdeltaCompilerTest extends EdeltaAbstractTest {
  ...
  public void testCompilationRenamedClassInModifyEcore() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("EAttribute _newEAttribute = this.lib.newEAttribute(\"anotherAttr\", getEDataType(\"foo\", \"FooDataType\"));");
    _builder_1.newLine();
    _builder_1.append("    ");
  ...
  public void testCompilationOfNonAmbiguousEcorerefAfterRemoval() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("this.lib.addNewEAttribute(it_1, \"created\", null);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("};");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("this.lib.addNewEClass(it, \"ANewClass\", _function);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("final Consumer<EClass> _function_1 = (EClass it_1) -> {");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("this.lib.addNewEReference(it_1, \"created\", null);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("};");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("this.lib.addNewEClass(it, \"AnotherNewClass\", _function_1);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("EList<EClassifier> _eClassifiers = it.getEClassifiers();");
    _builder_1.newLine();
  ...
  public void testCompilationOfPersonListExampleModifyEcore() {
    ...
    _builder.newLine();
    _builder.append("      ");
    _builder.append("this.lib.addNewEAttribute(it_1, \"description\", getEDataType(\"ecore\", \"EString\"));");
    _builder.newLine();
    _builder.append("      ");
