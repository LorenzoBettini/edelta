...
public class EdeltaCompilerTest extends EdeltaAbstractTest {
  ...
  public void testCompilationOfComplexOperationsWithSubPackages() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("final Consumer<EAttribute> _function_2 = (EAttribute it_2) -> {");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("it_2.setEType(getEDataType(\"foo\", \"FooDataType\"));");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("};");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("EAttribute _newEAttribute = this.lib.newEAttribute(\"newTestAttr\", _function_2);");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("_eStructuralFeatures.add(_newEAttribute);");
    _builder_1.newLine();
