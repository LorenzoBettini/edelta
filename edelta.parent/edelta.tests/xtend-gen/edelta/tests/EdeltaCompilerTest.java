...
public class EdeltaCompilerTest extends EdeltaAbstractTest {
  ...
  public void testCompilationOfComplexOperationsWithSubPackages() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("this.lib.addNewESubpackage(it_1, \"anestedsubpackage\", \"aprefix2\", \"aURI2\", _function_1);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("};");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("this.lib.addNewESubpackage(it, \"anewsubpackage\", \"aprefix\", \"aURI\", _function);");
    _builder_1.newLine();
    _builder_1.append("    ");
