...
public class EdeltaCompilerTest extends EdeltaAbstractTest {
  ...
  public void testCompilationOfPersonListExampleModifyEcore() {
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("EClass _extractMetaClass = this.refactorings.extractMetaClass(\"WorkingPosition\", getEReference(\"PersonList\", \"Person\", \"works\"));");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("final Procedure1<EClass> _function = (EClass it_1) -> {");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("getEReference(\"PersonList\", \"WorkPlace\", \"workingPosition\").setName(\"position\");");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("getEReference(\"PersonList\", \"Person\", \"workingPosition\").setName(\"works\");");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("}");
    _builder.newLine();
