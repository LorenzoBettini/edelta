...
import edelta.resource.derivedstate.EdeltaEcoreReferenceExpressionAccessibleElements;
...
public class EdeltaInterpreterTest extends EdeltaAbstractTest {
  ...
  public void testAccessibleElements() {
    ...
    final Procedure1<EdeltaProgram> _function = (EdeltaProgram it) -> {
      ...
      final EdeltaEcoreReferenceExpression ecoreref3 = this.getAllEcoreReferenceExpressions(it).get(3);
      final EdeltaEcoreReferenceExpressionAccessibleElements elements1 = this.derivedStateHelper.getAccessibleElements(ecoreref1);
      StringConcatenation _builder_1 = new StringConcatenation();
      ...
      final EdeltaEcoreReferenceExpressionAccessibleElements elements2 = this.derivedStateHelper.getAccessibleElements(ecoreref2);
      StringConcatenation _builder_2 = new StringConcatenation();
      ...
      _builder_2.newLine();
      this.assertQualifiedNames(elements2, _builder_2);
      final EdeltaEcoreReferenceExpressionAccessibleElements elements3 = this.derivedStateHelper.getAccessibleElements(ecoreref3);
      ...
      _builder_3.newLine();
      this.assertQualifiedNames(elements3, _builder_3);
    };
    ObjectExtensions.<EdeltaProgram>operator_doubleArrow(_parseWithTestEcore, _function);
  }
