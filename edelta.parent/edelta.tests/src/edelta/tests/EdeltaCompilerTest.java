...
public class EdeltaCompilerTest extends EdeltaAbstractCompilerTest {
	...
	@Test
	public void testIncompleteProgram() throws Exception {
		checkCompilation(
			"metamodel ",
			"""
			package edelta;
	...
	@Test
	public void testOperationWithInferredReturnType() throws Exception {
		checkCompilation(
			inputs.operationWithInferredReturnType(),
			"""
			package foo;
	...
	@Test
	public void testOperationWithReturnType() throws Exception {
		checkCompilation(
			inputs.operationWithReturnType(),
			"""
			package foo;
	...
	@Test
	public void testOperationAccessingLib() throws Exception {
		checkCompilation(
			inputs.operationAccessingLib(),
			"""
			package foo;
	...
	@Test
	public void testOperationNewEClassWithInitializer() throws Exception {
		checkCompilation(
			inputs.operationNewEClassWithInitializer(),
			"""
			package foo;
	...
	@Test
	public void testCompilationOfEcoreReferenceExpression() throws Exception {
		checkCompilation(
			"""
			package foo;
	...
	@Test
	public void testCompilationOfEclassExpressionWithNonExistantEClass() throws Exception {
		checkCompilation(
			"""
			package foo;
	...
	public void testReferenceToCreatedEClass() throws Exception {
		checkCompilation(
			inputs.referenceToCreatedEClass(),
			"""
			package edelta;
	...
	public void testReferenceToCreatedEClassRenamed() throws Exception {
		...
		checkCompilation(
			inputs.referenceToCreatedEClassRenamed(),
			"""
			package edelta;
	...
	@Test
	public void testUseAsExtension() throws Exception {
		checkCompilation(
	...
	@Test
	public void testInvalidUseAs() throws Exception {
		checkCompilation(
			"""
			import edelta.tests.additional.MyCustomEdelta
	...
	@Test
	public void testUseAsExecution() throws Exception {
	...
	@Test
	public void testUseAsExtensionExecution() throws Exception {
		// the new created EClass and EAttribute are created by calling a method
		// of a custom Edelta implementation that is used in the program
		checkCompiledCodeExecution(
			inputs.useAsCustomEdeltaAsExtensionCreatingEClass(),
	...
	@Test
	public void testStatefulUseAsExecution() throws Exception {
		// the new created EClass and EAttribute are created by calling a method
		// of a custom Edelta implementation that is used in the program
		checkCompiledCodeExecution(
	...
	@Test
	public void testModifyEcore() throws Exception {
		checkCompilation(
			"""
			metamodel "foo"
	...
	@Test
	public void testCompilationRenamedClassInModifyEcore() throws Exception {
		checkCompilation(
			"""
			metamodel "foo"
	...
	@Test
	public void testExecutionRenamedClassInModifyEcore() throws Exception {
		checkCompiledCodeExecution(
			"""
			metamodel "foo"
	...
	@Test
	public void testCompilationAfterInterpretationOfCreatedEClassStealingAttribute() throws Exception {
		checkCompilation(
			inputs.createEClassStealingAttribute(),
			"""
			package edelta;
	...
	@Test
	public void testCompilationAfterInterpretationChangeEClassRemovingAttribute() throws Exception {
		checkCompilation(
			inputs.changeEClassRemovingAttribute(),
			"""
			package edelta;
	...
	@Test
	public void testCompilationOfModifyEcoreCallingLibMethods() throws Exception {
		checkCompilation(
			inputs.modifyEcoreUsingLibMethods(),
			"""
			package edelta;
	...
	@Test
	public void testCompilationEcorerefWhenAttributeRemovedFromOriginalContainer() throws Exception {
		checkCompilation(
			"""
			metamodel "foo"
	...
	@Test
	public void testCompilationEcorerefWhenElementRemovedFromEcoreReference() throws Exception {
	...
	@Test
	public void testCompilationOfComplexOperationsWithSubPackages() throws Exception {
		checkCompilation(
			"""
			metamodel "foo"
	...
	@Test
	public void testCompilationOfRenameReferencesAcrossEPackagesWithRealEcoreFiles() throws Exception {
		...
		var rs = createResourceSetWithEcores(
			List.of(TEST1_REFS_ECORE, TEST2_REFS_ECORE),
			"""
			package test
		...
		addEPackagesWithReferencesForTests(rs);
		checkCompilation(
			rs,
			"""
			package test;
	...
	@Test
	public void testExecutionOfRenameReferencesAcrossEPackagesWithRealEcoreFiles() throws Exception {
		checkCompiledCodeExecution(
			List.of(TEST1_REFS_ECORE, TEST2_REFS_ECORE),
			"""
			package test
	...
	@Test
	public void testCompilationOfRenameReferencesAcrossEPackagesSingleModifyEcore() throws Exception {
	...
	@Test
	public void testExecutionOfRenameReferencesAcrossEPackagesSingleModifyEcore() throws Exception {
		checkCompiledCodeExecution(
			List.of(TEST1_REFS_ECORE, TEST2_REFS_ECORE),
			"""
			package test
	...
	@Test
	public void testExecutionOfModificationsOfMetamodelsAcrossSeveralFilesIntroducingDepOnAnotherMetamodel() throws Exception {
		checkCompiledCodeExecutionWithSeveralFiles(
			List.of(SIMPLE_ECORE, ANOTHER_SIMPLE_ECORE),
			List.of(
				"""
				import org.eclipse.emf.ecore.EClass
	...
	@Test
	public void testExecutionOfModificationsOfMetamodelsAcrossSeveralFilesIntroducingMutualDepOnAnotherMetamodel() throws Exception {
		checkCompiledCodeExecutionWithSeveralFiles(
			List.of(SIMPLE_ECORE, ANOTHER_SIMPLE_ECORE),
			List.of(
				"""
	...
	@Test
	public void testExecutionOfComplexOperationsWithSubPackages() throws Exception {
		checkCompiledCodeExecution(
			"""
			metamodel "foo"
	...
	@Test
	public void testCompilationOfSeveralFilesWithUseAs() throws Exception {
	...
	@Test
	public void testExecutionOfSeveralFilesWithUseAs() throws Exception {
		checkCompiledCodeExecutionWithSeveralFiles(
			List.of(SIMPLE_ECORE),
			List.of(
				"""
				import org.eclipse.emf.ecore.EClass
				import org.eclipse.emf.ecore.EcorePackage
	...
	@Test
	public void testExecutionOfSeveralFilesWithUseAsAndIssuePresenter() throws Exception {
		// see https://github.com/LorenzoBettini/edelta/issues/348
		var collectedWarnings = new java.util.ArrayList<String>();
		checkCompiledCodeExecutionWithSeveralFiles(
			List.of(SIMPLE_ECORE),
			List.of(
				"""
			...
			true,
			edelta -> {
				edelta.setIssuePresenter(new EdeltaIssuePresenter() {
					@Override
		...
		org.assertj.core.api.Assertions.assertThat(collectedWarnings)
			.containsExactly(
	...
	@Test
	public void testCompilationOfNonAmbiguousEcorerefAfterRemoval() throws Exception {
		...
		addEPackageWithSubPackageForTests(rs);
		checkCompilation(
			rs,
			"""
			package edelta;
	...
	@Test
	public void testEcoreRefExpForCreatedEClassInInitializer() throws Exception {
		checkCompilation(
			"""
	...
	@Test
	public void testCompilationOfPersonListExampleModifyEcore() throws Exception {
		var rs = createResourceSetWithEcores(
			List.of(PERSON_LIST_ECORE),
		...
		checkCompilation(
			...
			public class Example extends EdeltaDefaultRuntime {
			  ...
			  public void improvePerson(final EPackage it) {
			    ...
			    this.refactorings.<EAttribute>mergeFeatures("name", Collections.<EAttribute>unmodifiableList(CollectionLiterals.<EAttribute>newArrayList(getEAttribute("PersonList", "Person", "firstname"), getEAttribute("PersonList", "Person", "lastname"))));
			  }
			
			  public void introducePlace(final EPackage it) {
			    this.refactorings.extractSuperclass("Place", Collections.<EStructuralFeature>unmodifiableList(CollectionLiterals.<EStructuralFeature>newArrayList(getEAttribute("PersonList", "LivingPlace", "address"), getEAttribute("PersonList", "WorkPlace", "address"))));
			  }
			  ...
			  public void improveList(final EPackage it) {
			    this.refactorings.mergeFeatures("places", getEClass("PersonList", "Place"), Collections.<EStructuralFeature>unmodifiableList(CollectionLiterals.<EStructuralFeature>newArrayList(getEReference("PersonList", "List", "wplaces"), getEReference("PersonList", "List", "lplaces"))));
			  }
	...
	private void checkCompiledCodeExecution(CharSequence input, CharSequence expectedGeneratedEcore,
		...
		compilationTestHelper.compile(rs, it -> {
			...
			var genClass = it.getCompiledClass();
			var modelManager = new EdeltaModelManager();
			var defaultEdelta = new EdeltaDefaultRuntime(modelManager);
			EdeltaRuntime edeltaObj;
			try {
				edeltaObj = (EdeltaRuntime) genClass
					.getDeclaredConstructor(EdeltaRuntime.class)
					.newInstance(defaultEdelta);
				// load ecore files
				modelManager.loadEcoreFile("testecores/foo.ecore");
				edeltaObj.execute();
				modelManager.saveEcores(MODIFIED);
				EdeltaTestUtils.assertFileContents(MODIFIED + "/foo.ecore", expectedGeneratedEcore.toString());
			} catch (Exception e) {
	...
	private void checkCompiledCodeExecution(List<String> ecoreNames,
			CharSequence input,
			List<Pair<CharSequence, CharSequence>> expectedModifiedEcores,
			boolean checkValidationErrors) throws IOException {
		wipeModifiedDirectoryContents();
		var rs = createResourceSetWithEcores(ecoreNames, input);
		compilationTestHelper.compile(rs, it -> {
			if (checkValidationErrors) {
				assertNoValidationErrors(it);
			}
			...
			try {
				checkExecutionAndAssertExpectedModifiedEcores(genClass,
					ecoreNames, expectedModifiedEcores, edelta -> {}
				);
			} catch (Exception e) {
				throw new RuntimeException(e);
			}
	...
	private void checkCompiledCodeExecutionWithSeveralFiles(List<String> ecoreNames,
	...
	private void checkCompiledCodeExecutionWithSeveralFiles(List<String> ecoreNames,
			...
			Consumer<EdeltaRuntime> instanceConsumer) throws IOException {
		wipeModifiedDirectoryContents();
		var rs = createResourceSetWithEcoresAndSeveralInputs(ecoreNames, inputs);
		compilationTestHelper.compile(rs, it -> {
			if (checkValidationErrors) {
				assertNoValidationErrors(it);
			}
			...
			var genClass = it.getCompiledClass(classToExecute);
			try {
				checkExecutionAndAssertExpectedModifiedEcores(genClass,
	...
	private void checkExecutionAndAssertExpectedModifiedEcores(Class<?> genClass,
		List<String> ecoreNames, List<Pair<CharSequence, CharSequence>> expectedModifiedEcores,
		Consumer<EdeltaRuntime> instanceConsumer
	) throws Exception {
		var modelManager = new EdeltaModelManager();
		var mainEdelta = new EdeltaDefaultRuntime(modelManager);
		EdeltaRuntime edeltaObj;
		try {
			edeltaObj = (EdeltaRuntime) genClass
				.getDeclaredConstructor(EdeltaRuntime.class)
				.newInstance(mainEdelta);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
		instanceConsumer.accept(edeltaObj);
		// load ecore files
		for (String ecoreName : ecoreNames) {
			modelManager.loadEcoreFile(METAMODEL_PATH + ecoreName);
		}
		edeltaObj.execute();
		modelManager.saveEcores(MODIFIED);
		for (Pair<CharSequence, CharSequence> expected : expectedModifiedEcores) {
			EdeltaTestUtils.assertFileContents(
				MODIFIED + "/" + expected.getKey(),
	...
	private void wipeModifiedDirectoryContents() throws IOException {
		EdeltaTestUtils.cleanDirectory(MODIFIED);
	}
