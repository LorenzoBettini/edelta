...
/**
 * This is the item provider adapter for a {@link GraphMM.Dependency} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DependencyItemProvider extends EdgeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dependency_src_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dependency_src_feature", "_UI_Dependency_type"),
				 GraphMMPackage.Literals.DEPENDENCY__SRC,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTrgPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dependency_trg_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dependency_trg_feature", "_UI_Dependency_type"),
				 GraphMMPackage.Literals.DEPENDENCY__TRG,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addBidirectionalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dependency_bidirectional_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dependency_bidirectional_feature", "_UI_Dependency_type"),
				 GraphMMPackage.Literals.DEPENDENCY__BIDIRECTIONAL,
				 true,
				 false,
				 false,
